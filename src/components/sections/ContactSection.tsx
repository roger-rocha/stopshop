            ...
            <StaggerChildren className="mt-8 space-y-4">
              <StaggerItem className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="tel:4732557000" className="text-brand-cream hover:text-brand-coral transition-colors">
                    (47) 3255-7000
                  </a>
                </div>
              </StaggerItem>
              <StaggerItem className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:comercial@stopshop.com.br" className="text-brand-cream hover:text-brand-coral transition-colors">
          ...
          <AnimateOnScroll variants={slideInRight}>
            ...
            >
              <input
                ...
                className="w-full rounded-button border border-border-subtle bg-surface-dark px-4 py-3 text-brand-cream placeholder:text-text-muted/50 outline-none focus:border-brand-coral focus:ring-1 focus:ring-brand-coral transition-all"
              />
              <input
                type="email"
                ...
                className="w-full rounded-button border border-border-subtle bg-surface-dark px-4 py-3 text-brand-cream placeholder:text-text-muted/50 outline-none focus:border-brand-coral focus:ring-1 focus:ring-brand-coral transition-all"
              />
              <select className="w-full rounded-button border border-border-subtle bg-surface-dark px-4 py-3 text-text-muted outline-none focus:border-brand-coral focus:ring-1 focus:ring-brand-coral transition-all">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-button border border-border-subtle bg-surface-dark px-4 py-3 text-brand-cream placeholder:text-text-muted/50 outline-none focus:border-brand-coral focus:ring-1 focus:ring-brand-coral transition-all"
              />
              <button
                type="submit"
