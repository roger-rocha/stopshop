...
export const segments: SeedSegment[] = [
  ...
  { id: "8", name: "Acessórios", slug: "acessorios", color: "#D4A853", storeCount: 14, image: "https://images.unsplash.com/photo-1523170335258-f5ed11844a49?w=800&q=80" },
  ...
  { id: "12", name: "Alimentação", slug: "alimentacao", color: "#E59547", storeCount: 8, image: "https://images.unsplash.com/photo-1552566626-52f8b828add9?w=800&q=80" },
